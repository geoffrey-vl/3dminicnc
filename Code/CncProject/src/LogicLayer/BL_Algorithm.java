 ...
 */
public class BL_Algorithm {
    private IO_SerialsComms io;
    private int[][] millingPathArr;
    private ArrayList<BL_Pixel> millingPath;
    ...
    public BL_Algorithm(int width, int height, double diameter, int layers, int[][] highestLayerImg, double scale, double depthScale, IO_SerialsComms io) {
        this.io = io;
        this.width = width;
        this.height = height;
